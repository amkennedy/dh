function [msg,status] = rs_dh(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
      ...
      if gce_valid(data)
         ...
         %begin elevated qc routine using seperate qc_stats file
            ...
            if ~isempty(col)
                ...
                if ~isempty(data)
                    cols = {'Month','Day','Hour','Year','Minute','Second','RecNum','MEAN','STD','MIN','MAX','FOURLO','FOURHI','MEDIAN'};
...
%          end
         ...
         if ~isempty(data)
             ...
             clear col delcols dummy myDateTime
