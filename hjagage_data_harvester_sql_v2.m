function [msg,status] = hjagage_data_harvester_sql_v2(source,qc_source,template,sitecode,profile,pn_dest,pn_plots,html,email,fn_dest,reprocess)
%Data harvester function template for post-processing streaming sensor data retrieved from an SQL data source
%Revised for table based loggers sent to the field in 2015.
%
   ...
   if exist(source,'file') == 2
      ...
      if gce_valid(data)
         ...
         if ~isempty(data)
             ...
             interpcols = {'PRECIP_INST_455_0_01','WATERTEMP_MEAN_0_0_01','WATERTEMP_MEAN_0_0_02','STAGE_INST_0_0_01','FISHSTAGE_INST_0_0_01', ...
                 'EC_INST_0_0_01','EC_INST_0_0_02','WATERTEMP_INST_0_0_01','WATERTEMP_INST_0_0_02','AIRTEMP_MEAN_150_0_01'};
         ...
         if ~isempty(col)
             ...
             if ~isempty(data)
                 cols = {'Month','Day','Hour','Year','Minute','Second','RecNum','air_TWOLO','air_TWOHI','air_THREELO','air_THREEHI', ...
                     'water_TWOLO','water_TWOHI','water_THREELO','water_THREEHI'};
